...
upass = str(input())
if upass == decpass:
    Speak("Welcome Back Sir! it's Luna, Please enjoy the music while i prepare all the functions to use!")
    ...
    def recognize_main(): #Main reply call function
        ...
        try:
            ...
            if "start" in data:
                Speak("There are currently four services that Luna offers, you can select any one of them, Today's Article!,Today's Fact!,Today's News!,What happend today in history!")
